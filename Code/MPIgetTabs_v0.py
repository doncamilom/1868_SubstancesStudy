...
def getCommonal(Rs,cmpnds,elemDict):
    ...
    for i,R_ in enumerate(Rs):
        ...
        for comp in cmpnds:  #Loop through all compounds on this subset
            ...
            for i in elemInCmpnd:  #loop through elements present in this compound
                ...
                #If removing element i (in proportion n) from this compound gives the same R, then R-i_n exists 
                if np.all((comp - tmp)==R):                         
